    ...
    try {
      ...
      if (savedFormData) {
        try {
          ...
          alert("Your car listing has been saved successfully!");
          ...
          alert("Logged in successfully, but there was an error saving your car listing. Please try again from the sell-car page.");
        }
      }
